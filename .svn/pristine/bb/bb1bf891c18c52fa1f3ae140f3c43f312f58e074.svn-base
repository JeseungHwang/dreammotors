...
<body>
	...
	<div class="container">
		...
		<div class="signin-field-container">
			...
			<div class="sign-form">
				<div id="info-label-form"><span id="info-label">직책</span></div>
				<div id="info-context">
					<input type="text" class="info-wContent" id="myin-posi" name="inpNm" readonly="readonly" value="<%=vo.getPositionName()%>"/>
					<p id="myin-nm-help"></p>
				</div>
			</div>

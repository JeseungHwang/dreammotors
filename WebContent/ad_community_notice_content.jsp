...
<%@ page import="java.util.*, com.dreammotors.vo.BoardVO, com.dreammotors.vo.BoardCommentVO"%>
...
<body>
	...
	<div class="container">
		...
		<div class="directory-label">
			<label class="control-label"><span class="glyphicon glyphicon-home" aria-hidden="true"></span> 커뮤니티 <span class="glyphicon glyphicon-menu-right" aria-hidden="true"></span> 공지사항<span class="glyphicon glyphicon-menu-right" aria-hidden="true"></span> 글내용</label>
		</div>
	...
	<script type="text/javascript">
		function btn_brdModify(){
			submitPost('${pageContext.request.contextPath}/nobrd_modiform.do', {'index':<%= board.getBoardIndex()%>});
		}
		function btn_brdDelete(){
			if(!confirm("해당 글을 삭제하시겠습니까?")){
				return
			}else{
				submitPost('${pageContext.request.contextPath}/nobrd_delete.do', {'index':<%= board.getBoardIndex()%>});
			}
		}
	</script>
</html>
...
<body>
	...
	<div class="container">
		...
		<div class="directory-label">
			<label class="control-label"><span class="glyphicon glyphicon-home" aria-hidden="true"></span> 드림모터스 <span class="glyphicon glyphicon-menu-right" aria-hidden="true"></span> 회사 소개</label>
		</div>
		...
		<div id="right-conentform">
			<div style="width: 100%; height: 100%;">
				<img alt="" src="img/banner/introduce_company.png">
			</div>
		</div>
	</div>

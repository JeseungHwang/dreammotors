...
<body>
	...
	<div class="container">
		...
		<div class="directory-label">
			<label class="control-label"><span class="glyphicon glyphicon-home" aria-hidden="true"></span> 커뮤니티 <span class="glyphicon glyphicon-menu-right" aria-hidden="true"></span> 고객후기<span class="glyphicon glyphicon-menu-right" aria-hidden="true"></span> 글내용</label>
		</div>

...
<body>
	...
	<div class="container">
		...
		<div class="directory-label">
			<label class="control-label"><span class="glyphicon glyphicon-home" aria-hidden="true"></span> 커뮤니티 <span class="glyphicon glyphicon-menu-right" aria-hidden="true"></span> 고객 후기<span class="glyphicon glyphicon-menu-right" aria-hidden="true"></span> 글수정</label>
		</div>
		...
		<div id="right-conentform">
			<form action="${pageContext.request.contextPath}/cubrd_modify.do" class="form-horizontal" id="cubrd-modifyForm" method="POST">
				<div id="brd-form-group">
					<div id="brd-label-form"><span id="brd-label">제목</span></div>
					<div id="brd-context">
						<input type="text" class="brd-wTitle" id="cuboard-wTitle" name="inpTitle" autofocus value="<%= board.getBoardTitle()%>">
				...
				<div id="brd-form-group">
					...
					<div id="brd-context">
						<input type="text" class="brd-wNm" id="cuboard-wNm" name="inpNm" value="<%= board.getBoardRegName()%>">
						<p id="cub-nm-help"></p>
					</div>
				</div>
				<div id="brd-form-group">
					...
					<div id="brd-context">
						<input type="text" class="brd-wTell" id="cuboard-wTell" placeholder="- (하이픈) 없이 입력해주세요" name="inpTell" maxlength="11" value="<%= board.getBoardTell()%>">
				...
				<div id="brd-form-group1">
					...
					<div id="brd-context">
						<textarea name="inpContent" id="cubrd-modify-content" rows="10" cols="100" style="width:100%; height:412px; display:none;"><%= board.getBoardContext()%></textarea>
					</div>
				</div>
	...
	<script type="text/javascript">
		$(document).ready(function(){	
			$('#cubrd-modifyForm').submit(function(ev) {
				 ev.preventDefault(); // to stop the form from submitting
				    ...
				    if(isEmpty[0] && isEmpty[1] && isEmpty[2]){
				    	oEditors.getById["cubrd-modify-content"].exec("UPDATE_CONTENTS_FIELD", []);
		...
		nhn.husky.EZCreator.createInIFrame({
			oAppRef : oEditors,
			elPlaceHolder : "cubrd-modify-content",
